    ...
    <div>
      <div class="col-6 mx-auto mt-5">
        ...
        <div class="input-group mb-3">
          ...
          <input type="file" ref="file" @change="selectImage"/> <!-- type을 파일로 해주어야한다. -->
    ...
    methods: {
        selectImage(){
            ...
            // ref="file"로 해놧으므로 file로 접근해야한다.
             this.currentImage = this.$refs.file.files[0]; // 배열의 특징을 가지므로 file0을 해주어야한다. 아니면 배열에서 몇번째를 가져오는 지를 모름
             this.message="";
